...
Khi bạn thực hiện truy vấn này với `"auto_generate_synonyms_phrase_query":` true, Elasticsearch có thể tìm kiếm cả các từ đồng nghĩa của "new," "york," và "city," giúp bạn mở rộng tìm kiếm. 
 - Nên để là false để kiểm soát từ ngữ tìm kiếm
